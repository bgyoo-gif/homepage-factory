# GlossaryPage_BlockedAiWorkflow — Deutsche Übersetzung (localize)
...
The workflow exists. The data exists. The model exists. The integration is blocked because the data cannot leave.
Der Prozess ist vorhanden, die Daten sind vorhanden, das Modell ist vorhanden. Die Integration scheitert daran, dass die operativen Daten die regulierte Umgebung nicht verlassen dürfen.
