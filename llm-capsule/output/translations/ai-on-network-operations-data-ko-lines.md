...
<td>Device ID (e.g. R-472)</td>
<td>장비 ID (예: R-472)</td>

<td>Tokenized with structure preserved</td>
<td>구조 보존 토크나이즈</td>

<td>Yes — original ID returned</td>
<td>예 — 원본 ID 복원</td>

<td>Cell site ID (e.g. SEO-18)</td>
<td>셀 사이트 ID (예: SEO-18)</td>

<td>Tokenized; geographic hint generalized</td>
...
<td>Field-level redaction</td>
<td>필드 수준 삭제</td>

<td>Yes (if policy allows)</td>
<td>예 (정책 허용 시)</td>

<td>Alarm sequence</td>
<td>알람 시퀀스</td>

<td>Sequence preserved; absolute timestamps fuzzed by DP</td>
<td>시퀀스 보존, 절대 타임스탬프 DP 퍼징</td>

<td>Yes — original sequence returned</td>
<td>예 — 원본 시퀀스 복원</td>

<td>SLA impact value</td>
<td>SLA 영향 값</td>

<td>Bucketed under DP for aggregate reasoning</td>
<td>집계 추론을 위해 DP 버킷 처리</td>

<td>Original value preserved separately</td>
<td>원본 값 별도 보존</td>

<td>Topology graph</td>
<td>토폴로지 그래프</td>

<td>Structurally preserved, identifiers tokenized</td>
