...
> Regelwerke: `localization-brief-de.md`, `translation-guide.md`
> Modus: localize
...
Eine KI-Datenkapsel kapsuliert sensible Daten vor der KI-Verarbeitung und stellt sie danach wieder her. Erfahren Sie, wie sich Kapsulierung von Datenmaskierung und Schwärzung unterscheidet.
...
Kapsulierung von Unternehmensdaten für den sicheren LLM-Einsatz. Sensible Daten werden lokal geschützt, bevor sie an einen KI-Dienst übermittelt werden. Nach der Verarbeitung werden die Ergebnisse mit den Originaldaten angereichert und sind direkt einsetzbar.
...
Konzept der KI-Datenkapsel — Originaldokument im Vergleich zur kapsulierten Version mit erhaltener Dokumentstruktur
...
Unternehmen müssen vertrauliche Dokumente durch Large Language Models verarbeiten lassen — zur Zusammenfassung, Extraktion, Übersetzung und Analyse. Der Versand ungeschützter Rohdaten an externe KI-Dienste führt zu inakzeptabler Offenlegung vertraulicher Informationen. Bestehende Ansätze wie Maskierung, Schwärzung und Tokenisierung zerstören dabei den Kontext, den KI-Modelle für verwertbare Ergebnisse benötigen.

The result is a binary choice: expose data to use AI, or protect data and get unusable results.
Das Ergebnis ist ein Entweder-oder: Daten offenlegen, um KI nutzen zu können — oder Daten schützen und unbrauchbare Ergebnisse in Kauf nehmen.
...
Lokale Kapsulierung. Sensible Elemente in Unternehmensdokumenten — Namen, Kontonummern, Datumsangaben, medizinische Codes und Vertragsklauseln — werden identifiziert und durch strukturerhaltende Repräsentationen ersetzt. Die Zuordnung zwischen Original- und Ersatzwerten wird lokal gespeichert und niemals übertragen.
...
Geschützte KI-Verarbeitung. Das kapsulierte Dokument wird an ein beliebiges externes LLM gesendet. Da die Dokumentstruktur erhalten bleibt, kann das KI-Modell Zusammenfassungen, Extraktionen, Klassifizierungen und Übersetzungen effektiv durchführen. Sensible Originaldaten verlassen die Unternehmensumgebung zu keinem Zeitpunkt.
...
Lokale Wiederherstellung. KI-Ergebnisse werden automatisch lokal mit den originalen Unternehmensdaten angereichert. Die lokal gespeicherte Zuordnung wird angewendet, um Ergebnisse mit echten Namen, Beträgen und Referenzen zu rekonstruieren — direkt einsetzbar in bestehenden Geschäftsprozessen.
...
Kernkonzept: KI-Ergebnisse werden automatisch lokal mit den Originaldaten zusammengeführt. Die KI-Datenkapsel ermöglicht den KI-Einsatz im Unternehmen, da Originaldaten die Unternehmensumgebung zu keinem Zeitpunkt verlassen.
...
Compliance-Prüfung im Finanzbereich
...
Datenmaskierung entfernt sensible Informationen dauerhaft — KI-Ergebnisse sind danach für Geschäftsprozesse nicht mehr verwertbar. Eine KI-Datenkapsel hingegen erhält die Datenstruktur und ermöglicht die lokale Wiederherstellung: KI-Ergebnisse lassen sich vollständig in ihren ursprünglichen Unternehmenskontext zurückführen.

Does the AI data capsule work with any LLM?
Ist die KI-Datenkapsel mit jedem LLM kompatibel?
...
Ja. Da die Kapsel auf der Datenebene vor der Übertragung arbeitet, ist sie mit jedem externen KI-Dienst kompatibel: ChatGPT, Claude, Gemini oder jede beliebige LLM-API.
