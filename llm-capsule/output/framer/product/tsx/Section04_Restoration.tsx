...
export default function Section04_Restoration({
  ...
  sectionDescription = "LLM Capsule does more than hide data. It auto-restores usable output inside the environment after AI processing so enterprise teams can actually use the result in real workflows. This is a restorable workflow — not just protection, but context-preserving data layer for AI with usable output.",
