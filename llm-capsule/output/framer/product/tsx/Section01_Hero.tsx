...
const JSON_LD_PRODUCT = JSON.stringify({
  ...
  "name": "LLM Capsule",
  "description": "context-preserving data layer for AI and plugin. Zero exposure, local restoration, enterprise context control, structure-preserving processing, and enterprise environment execution for secure enterprise LLM usage.",
...
export default function Section01_Hero({
  title = "The context-preserving data layer for AI",
...
addPropertyControls(Section01_Hero, {
  title:           { type: ControlType.String, title: "Title",           defaultValue: "The context-preserving data layer for AI" },
  ...
  body:            { type: ControlType.String, title: "Body",            defaultValue: "Most enterprise AI security tools either block AI usage entirely or strip critical context through masking and redaction, producing outputs that cannot be used in real business processes. LLM Capsule takes a different approach: local encapsulation protects sensitive elements before AI processing, structure-preserving processing maintains document integrity for AI comprehension, local restoration auto-restores AI outputs with original enterprise data, and enterprise environment execution means no vendor lock-in. This enables enterprise context-preserving data layer for AI on document-heavy workflows including contracts, claims, regulatory filings, medical records, and internal reports.", displayTextArea: true },
