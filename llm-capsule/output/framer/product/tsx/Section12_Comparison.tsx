...
export default function Section12_Comparison({
  ...
  bannerText = "AI results are auto-restored through local restoration. This is the fundamental capability that separates LLM Capsule from every other approach — enterprise context-preserving data layer for AI that produces usable outputs, not abstracted placeholders.",
  row1Title = "Traditional Masking / Redaction",
  row2Title = "Prompt Security Gateways",
  row3Title = "LLM Capsule",
  row1Dim = "context-preserving data layer for AI",
...
addPropertyControls(Section12_Comparison, {
  ...
  row1Dim:            { type: ControlType.String, title: "R1 Dimension",  defaultValue: "context-preserving data layer for AI" },
