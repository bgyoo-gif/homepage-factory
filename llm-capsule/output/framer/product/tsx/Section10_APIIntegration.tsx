...
export default function Section10_APIIntegration({
  ...
  body = "The API provides LLM API integration at the data layer — wrap any existing AI integration with encapsulation and restoration without rebuilding the application.",
        ...
        <div className="s10-inner">
          <div className="s10-container">
            <div className="s10-header">
              <h2 className="s10-header__title" style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>
...
addPropertyControls(Section10_APIIntegration, {
  ...
  body:               { type: ControlType.String, title: "Body",          defaultValue: "The API provides LLM API integration at the data layer — wrap any existing AI integration with encapsulation and restoration without rebuilding the application.", displayTextArea: true },
