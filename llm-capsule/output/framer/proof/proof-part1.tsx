...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  ko: {
    heroTag: "신뢰 증거",
    heroHeadline: "증거.",
    heroHeadlineAccent: "레이어 뒤의 근거입니다.",
    heroSub: "실제 운영 사례. 보안 인증. 특허. 연구. 수상 이력. 파트너십. 구매 담당자·보안팀·감사팀이 필요로 하는 신뢰 지표를 한곳에 모았습니다.",
    bannerStrong: "안전한 AI 사용",
    bannerBody: "이란 민감 데이터가 내부 환경에 머무른다는 의미입니다. 보호된 캡슐만 AI에 전달되고, 결과물은 원래 워크플로우 안에서 로컬로 복원됩니다. 활용 가능하고, 프라이버시가 보호되며, 검증 가능합니다.",
    trustLabel: "// 규제 산업 전반에 배포 완료 — 금융 · 공공 · 국방 · 의료 · 통신",
    trustGroup1Title: "고객사",
    trustGroup2Title: "인증",
    trustGroup3Title: "파트너",
    trustGroup4Title: "수상 및 선정",
  },
  de: {
    heroTag: "Vertrauensnachweise",
    heroHeadline: "Nachweise.",
    heroHeadlineAccent: "Fakten hinter der Datenschicht.",
    heroSub: "Dokumentierte Betriebsfälle. Sicherheitszertifizierungen. Patente. Forschung. Auszeichnungen. Partnerschaften. Die Belege, die Einkauf, IT-Sicherheit und Revision benötigen &mdash; gebündelt an einem Ort.",
    bannerStrong: "Datenschutzkonforme KI-Nutzung",
    bannerBody: " bedeutet: Vertrauliche Daten verlassen Ihre Umgebung nicht. Nur eine geschützte Kapsel wird durch die KI verarbeitet. Die Ausgabe wird lokal in den ursprünglichen Workflow zurückgeführt &mdash; fachlich nutzbar, datenschutzkonform und nachvollziehbar.",
    trustLabel: "// Einsatz in regulierten Branchen — Finanzwesen · Öffentliche Hand · Verteidigung · Gesundheitswesen · Telekommunikation",
    trustGroup1Title: "Kunden",
    trustGroup2Title: "Zertifizierungen",
    trustGroup3Title: "Partner",
    trustGroup4Title: "Auszeichnungen",
  },
}
