...
export default function Section05_GlossaryGrid({
  ...
  t8Term = "Shadow AI",
  t8Definition = "Unsanctioned external LLM use; symptom of missing AI enablement data layer.",
...
addPropertyControls(Section05_GlossaryGrid, {
  ...
  t1Term:       { type: ControlType.String, title: "T1 Term",     defaultValue: "AI enablement data layer" },
  ...
  t1Slug:       { type: ControlType.String, title: "T1 Slug",     defaultValue: "/glossary/ai-enablement-data-layer" },
  ...
  t8Definition: { type: ControlType.String, title: "T8 Def",      defaultValue: "Unsanctioned external LLM use; symptom of missing AI enablement data layer.", displayTextArea: true },
