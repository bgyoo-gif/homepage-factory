...
export default function Section05_ComparisonTable({
  ...
  thCol3 = "LLM Capsule (Context-Preserving Data Layer for AI)",
...
addPropertyControls(Section05_ComparisonTable, {
  ...
  thCol3: { type: ControlType.String, title: "TH: Col 3", defaultValue: "LLM Capsule (Context-Preserving Data Layer for AI)" },
