...
addPropertyControls(Section12_FAQ, {
  ...
  faq1Answer:   { type: ControlType.String, title: "FAQ 1 Answer",   defaultValue: "LLM Capsule acts as a context-preserving data layer for AI that encapsulates sensitive data locally before it leaves the enterprise environment. Only protected representations are sent to AI models. After processing, outputs are restored locally so they remain usable for real enterprise workflows. The original data never reaches external AI services — this is what makes it a context-preserving data layer for AI plugin rather than a monitoring or filtering tool.", displayTextArea: true },
  ...
  faq3Answer:   { type: ControlType.String, title: "FAQ 3 Answer",   defaultValue: "Prompt security gateways filter at the API level — they scan prompts for sensitive patterns and block or strip flagged content. They cannot protect enterprise documents processed through RAG pipelines or batch workflows, and they provide no output restoration. LLM Capsule operates as a data layer plugin, encapsulating sensitive elements before any AI processing occurs and restoring outputs afterward. The two approaches can be complementary, but only a data-layer approach provides end-to-end context-preserving data layer for AI on enterprise data.", displayTextArea: true },
