...
interface Props {
  ...
  industry1Title?: string
  industry2Title?: string
  industry3Title?: string
  industry4Title?: string
  industry5Title?: string
  industry6Title?: string
  ctaBtnLabel?: string
}
...
export default function Section04_IndustryProof({
  ...
  industry1Title = "Public Sector",
  industry2Title = "Finance & Insurance",
  industry3Title = "Healthcare",
  industry4Title = "Legal",
  industry5Title = "Telecom",
  industry6Title = "Network Security",
  ctaBtnLabel = "See industry solutions",
}: Props) {
  return (
    <>
      <style>{`
          ...
          <section id="section-4" className="idx-section">
            <div className="idx-container">
              <div className="idx-section-header idx-section-header--underline">
                <h2 className="idx-section-header__title" style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>{industryHeading}</h2>
              ...
              <div className="idx-feature-grid">
                <a href="/solutions" className="idx-feature-item">
                  ...
                  <span className="idx-feature-item__title">{industry1Title}</span>
                </a>
                <a href="/solutions" className="idx-feature-item">
                  ...
                  <span className="idx-feature-item__title">{industry2Title}</span>
                </a>
                <a href="/solutions" className="idx-feature-item">
                  ...
                  <span className="idx-feature-item__title">{industry3Title}</span>
                </a>
                <a href="/solutions" className="idx-feature-item">
                  <div className="idx-feature-item__icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg></div>
                  <span className="idx-feature-item__title">{industry4Title}</span>
                </a>
                <a href="/solutions" className="idx-feature-item">
                  ...
                  <span className="idx-feature-item__title">{industry5Title}</span>
                </a>
                <a href="/solutions" className="idx-feature-item">
                  ...
                  <span className="idx-feature-item__title">{industry6Title}</span>
                </a>
              </div>

              <div className="idx-center-cta">
                <a href="/solutions" className="idx-btn idx-btn--secondary idx-btn--md">{ctaBtnLabel}</a>
              </div>
            </div>
          </section>
        </div>
...
addPropertyControls(Section04_IndustryProof, {
  ...
  industry1Title:     { type: ControlType.String, title: "Industry 1 Title",   defaultValue: "Public Sector" },
  industry2Title:     { type: ControlType.String, title: "Industry 2 Title",   defaultValue: "Finance & Insurance" },
  industry3Title:     { type: ControlType.String, title: "Industry 3 Title",   defaultValue: "Healthcare" },
  industry4Title:     { type: ControlType.String, title: "Industry 4 Title",   defaultValue: "Legal" },
  industry5Title:     { type: ControlType.String, title: "Industry 5 Title",   defaultValue: "Telecom" },
  industry6Title:     { type: ControlType.String, title: "Industry 6 Title",   defaultValue: "Network Security" },
  ctaBtnLabel:        { type: ControlType.String, title: "CTA Button Label",   defaultValue: "See industry solutions" },
})
