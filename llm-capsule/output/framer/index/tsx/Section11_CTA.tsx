    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .idx-cta-band__title {
          font-family: var(--f-display, 'Inter'), sans-serif; font-size: 40px; font-weight: 700;
        ...
        <div className="idx-inner">
          <div id="section-11" className="idx-cta-band">
            <div className="idx-cta-band__inner">
              <h2 className="idx-cta-band__title" style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>{ctaTitle}</h2>
