...
export default function Section07_ComparisonTable({
  ...
  sectionDesc = "A context-preserving data layer for AI for regulated workflows.",
  col1Header = "Approach",
  col2Header = "Method",
...
addPropertyControls(Section07_ComparisonTable, {
  ...
  sectionDesc:      { type: ControlType.String, title: "Description",    defaultValue: "A context-preserving data layer for AI for regulated workflows." },
