// Locale variant: Korean defaults pre-filled from architecture-4zone-technical-ko-lines.md.
...
export default function ArchitectureFourZoneTechnicalKo({
...
addPropertyControls(ArchitectureFourZoneTechnicalKo, {
  eyebrow: { type: ControlType.String, title: "Section · Eyebrow", defaultValue: "기술적 관점 · 존 기반 아키텍처" },
  sectionTitle: { type: ControlType.String, title: "Section · Title", defaultValue: "같은 아키텍처, 기술적 관점에서" },
  sectionDescription: { type: ControlType.String, title: "Section · Description", defaultValue: "아키텍트와 보안 검토자를 위한 자료 — 운영 데이터, 캡슐화, 그리고 어떤 LLM이든 어떻게 상호작용하는지에 대한 존 기반 전체 뷰.", displayTextArea: true },
  card1Num: { type: ControlType.String, title: "Card 1 · Num", defaultValue: "Zone 1 · 기업 내부 네트워크" },
  card1Title: { type: ControlType.String, title: "Card 1 · Title", defaultValue: "운영 시스템이 이미 있는 곳" },
  card1Description: { type: ControlType.String, title: "Card 1 · Description", defaultValue: "기존 엔터프라이즈 시스템 — ERP, CRM, 티켓팅, DMS / ECM, 레거시 DB, RAG 파이프라인 — 그대로 유지됩니다. 마이그레이션은 없습니다. Capsule은 소스에 따라 REST, gRPC, JDBC, 또는 Graph API를 통해 이들로부터 읽어옵니다.", displayTextArea: true },
  card2Num: { type: ControlType.String, title: "Card 2 · Num", defaultValue: "Zone 2 · DMZ — 비무장지대" },
  card2Title: { type: ControlType.String, title: "Card 2 · Title", defaultValue: "캡슐화가 일어나는 곳" },
  card2Description: { type: ControlType.String, title: "Card 2 · Description", defaultValue: "Enhanced Encapsulation Layer가 민감한 요소를 탐지하고, 문서 구조 보존·차등 프라이버시 기반 보호로 안전한 토큰으로 대체한 뒤, 캡슐을 라우팅 결정에 전달합니다. 원본 값은 로컬 토큰 맵에 보관된 채 남습니다.", displayTextArea: true },
  card3Num: { type: ControlType.String, title: "Card 3 · Num", defaultValue: "Zone 3 · 사내 팀" },
  card3Title: { type: ControlType.String, title: "Card 3 · Title", defaultValue: "거버넌스와 라우팅이 일어나는 곳" },
  card3Description: { type: ControlType.String, title: "Card 3 · Description", defaultValue: "조직 정책, 권한, 도메인 컨텍스트가 캡슐을 어디에서 처리할지 결정합니다 — 승인된 외부 LLM(Path A) 또는 온프레미스 로컬 모델(Path B). 결정은 워크플로우별 정책 기반이며, 완전한 감사 이력은 조직 내부에 보관됩니다.", displayTextArea: true },
  card4Num: { type: ControlType.String, title: "Card 4 · Num", defaultValue: "Zone 4 · 로컬 — 자동 복원" },
  card4Title: { type: ControlType.String, title: "Card 4 · Title", defaultValue: "AI 응답이 비즈니스에 바로 쓰일 수 있는 출력이 되는 곳" },
  card4Description: { type: ControlType.String, title: "Card 4 · Description", defaultValue: "AI 응답은 조직 내부에서만 토큰에서 원본 값으로 자동 복원됩니다. 신뢰 경계를 벗어난 데이터는 외부에서 복원될 수 없습니다. 복원된 출력은 원래의 워크플로우로 다시 전달됩니다.", displayTextArea: true },
  step1Title: { type: ControlType.String, title: "Z1 · Step Title", defaultValue: "소스 데이터" },
  step2Title: { type: ControlType.String, title: "Z2 · Step Title", defaultValue: "DP 캡슐화" },
  step3Title: { type: ControlType.String, title: "Z3 · Step Title", defaultValue: "AI 처리" },
  step4Title: { type: ControlType.String, title: "Z4 · Step Title", defaultValue: "로컬 자동 복원" },
  z1Label: { type: ControlType.String, title: "Z1 · Zone Label", defaultValue: "기업 내부 네트워크" },
  z1Sub: { type: ControlType.String, title: "Z1 · Zone Sub", defaultValue: "온프레미스 DB · 엔터프라이즈 시스템" },
  z2Label: { type: ControlType.String, title: "Z2 · Zone Label", defaultValue: "DMZ — 차등 프라이버시" },
  z2Sub: { type: ControlType.String, title: "Z2 · Zone Sub", defaultValue: "동일 조직 · EU 리전 · GDPR 대응" },
  z3Label: { type: ControlType.String, title: "Z3 · Zone Label", defaultValue: "사내 팀" },
  z3Sub: { type: ControlType.String, title: "Z3 · Zone Sub", defaultValue: "동일 조직 · 익명화 LLM 프록시" },
  z4Label: { type: ControlType.String, title: "Z4 · Zone Label", defaultValue: "로컬 — 자동 복원" },
  z4Sub: { type: ControlType.String, title: "Z4 · Zone Sub", defaultValue: "내부 전용 · 외부 반출 없음" },
  conn1Label: { type: ControlType.String, title: "Connector · 1→2 Label", defaultValue: "비정형 데이터 입력" },
  conn2Label: { type: ControlType.String, title: "Connector · 2→3 Label", defaultValue: "보호된 데이터 출력" },
  conn3Label: { type: ControlType.String, title: "Connector · 3→4 Label", defaultValue: "AI 응답 (토큰화)" },
  z1GroupTag: { type: ControlType.String, title: "Z1 · DB Group Tag", defaultValue: "비정형" },
  z1Db1Sub: { type: ControlType.String, title: "Z1 · DB1 Sub (use <br/>)", defaultValue: "고객 데이터<br/>개인 식별 정보(PII)" },
  z1Db2Sub: { type: ControlType.String, title: "Z1 · DB2 Sub (use <br/>)", defaultValue: "티켓 데이터<br/>CS 티켓 / 상태" },
  z1Db3Sub: { type: ControlType.String, title: "Z1 · DB3 Sub (use <br/>)", defaultValue: "상세 데이터<br/>비정형 클레임" },
  z1FieldsLabel: { type: ControlType.String, title: "Z1 · Raw Input Block Label", defaultValue: "원본 입력 필드" },
  z1F1Name: { type: ControlType.String, title: "Z1 · Field 1 Name", defaultValue: "고객" },
  z1F2Name: { type: ControlType.String, title: "Z1 · Field 3 Name", defaultValue: "자유 입력" },
  z1F2NameMid: { type: ControlType.String, title: "Z1 · Field 2 Name", defaultValue: "티켓" },
  z1GuardStrong: { type: ControlType.String, title: "Z1 · Guardrail Title", defaultValue: "PII 가드레일은 필드를 보호합니다. 기업은 구조 위에서 운영됩니다." },
  z1GuardBody: { type: ControlType.String, title: "Z1 · Guardrail Body (HTML)", defaultValue: "PII 필터를 비판하는 것이 아닙니다. 우리는 <b>다른 범주의 데이터</b>를 다룹니다 — 단순 필드 수준 마스킹으로는 보존할 수 없는 테이블 스키마, 상호 참조, 알람 시퀀스, 티켓 스레드입니다.", displayTextArea: true },
  z1PluginTag: { type: ControlType.String, title: "Z1 · Plug-in Tag", defaultValue: "AI 팀을 위한 플러그인" },
  ...
  z1Sys4Name: { type: ControlType.String, title: "Z1 · Sys 4 Name (Legacy)", defaultValue: "레거시" },
  z1Sys5Name: { type: ControlType.String, title: "Z1 · Sys 5 Name (Ticket)", defaultValue: "티켓" },
  ...
  z1ZeroModStrong: { type: ControlType.String, title: "Z1 · Zero-Mod Title", defaultValue: "시스템 수정 없음" },
  z1ZeroModBody: { type: ControlType.String, title: "Z1 · Zero-Mod Body", defaultValue: "기존 ERP, CRM, 레거시 시스템에 어떠한 수정도 없이 단일 API 호출로 연동됩니다.", displayTextArea: true },
  z2GroupTag: { type: ControlType.String, title: "Z2 · DB Group Tag", defaultValue: "캡슐화 플로우" },
  z2InSub: { type: ControlType.String, title: "Z2 · IN Sub", defaultValue: "원본 입력<br/>비정형 데이터" },
  z2ProcessSub: { type: ControlType.String, title: "Z2 · PROCESS Sub", defaultValue: "DP 엔진<br/>차등 프라이버시" },
  z2OutSub: { type: ControlType.String, title: "Z2 · OUT Sub", defaultValue: "캡슐화됨<br/>토큰 캡슐" },
  z2BlockLabel: { type: ControlType.String, title: "Z2 · Block Label", defaultValue: "캡슐화" },
  z2ProtectedBadge: { type: ControlType.String, title: "Z2 · Protected Badge", defaultValue: "✓ 보호됨" },
  z2F1Name: { type: ControlType.String, title: "Z2 · Field 1 Name", defaultValue: "이름" },
  z2F2Name: { type: ControlType.String, title: "Z2 · Field 2 Name", defaultValue: "Champ Id" },
  z2F3Name: { type: ControlType.String, title: "Z2 · Field 3 Name", defaultValue: "자유 입력" },
  z2DpEngineName: { type: ControlType.String, title: "Z2 · DP Engine Name", defaultValue: "DP 엔진" },
  z2DpEngineBadge: { type: ControlType.String, title: "Z2 · DP Engine Badge", defaultValue: "epsilon-DP 활성" },
  z2DpTech1: { type: ControlType.String, title: "Z2 · DP Tech 1", defaultValue: "노이즈 주입 (Laplace)" },
  z2DpTech2: { type: ControlType.String, title: "Z2 · DP Tech 2", defaultValue: "k-Anonymity 적용" },
  z2DpTech3: { type: ControlType.String, title: "Z2 · DP Tech 3", defaultValue: "의미 기반 토큰화" },
  z2DpTech4: { type: ControlType.String, title: "Z2 · DP Tech 4", defaultValue: "자유 텍스트 NER 마스킹" },
  z2DmzStrong: { type: ControlType.String, title: "Z2 · DMZ Title", defaultValue: "DMZ 보장" },
  z2DmzBody: { type: ControlType.String, title: "Z2 · DMZ Body", defaultValue: "단순 캡슐화를 넘어섭니다. 차등 프라이버시 기법으로 원본 민감 데이터를 <b>수학적으로 복원 불가능하게</b> 만듭니다.", displayTextArea: true },
  z3PipelineLabel: { type: ControlType.String, title: "Z3 · Pipeline Block Label", defaultValue: "LLM 파이프라인" },
  z3ProxyBadge: { type: ControlType.String, title: "Z3 · Proxy Badge", defaultValue: "LLM-a-Proxy" },
  z3ProxySub: { type: ControlType.String, title: "Z3 · Proxy Sub", defaultValue: "익명화 라우팅" },
  z3PathA: { type: ControlType.String, title: "Z3 · Path A Label", defaultValue: "Path A · 외부" },
  z3PathB: { type: ControlType.String, title: "Z3 · Path B Label", defaultValue: "Path B · 온프레미스" },
  z3DeployA1: { type: ControlType.String, title: "Z3 · Deploy A1 (External 1)", defaultValue: "퍼블릭 클라우드" },
  z3DeployA2: { type: ControlType.String, title: "Z3 · Deploy A2 (External 2)", defaultValue: "리전 호스팅" },
  z3DeployB1: { type: ControlType.String, title: "Z3 · Deploy B1 (On-prem 1)", defaultValue: "프라이빗" },
  z3DeployB2: { type: ControlType.String, title: "Z3 · Deploy B2 (On-prem 2)", defaultValue: "온프레미스" },
  z3SwapNote: { type: ControlType.String, title: "Z3 · Swap Note", defaultValue: "어떤 모델로 교체해도 — 캡슐 계약은 그대로입니다." },
  z3GuardStrong: { type: ControlType.String, title: "Z3 · Guardrail Title", defaultValue: "소스 DB 직접 접근 없음" },
  z3GuardBody: { type: ControlType.String, title: "Z3 · Guardrail Body", defaultValue: "AI 팀은 소스 데이터베이스에 절대 접근하지 않습니다. 구조 보존·차등 프라이버시 적용 데이터만 전달받습니다.", displayTextArea: true },
  z3IsoLabel: { type: ControlType.String, title: "Z3 · Isolation Block Label", defaultValue: "프라이버시 격리 모듈" },
  z3PdescHead: { type: ControlType.String, title: "Z3 · PDESC Head", defaultValue: "PDESC / ISOLA" },
  z3PdescItem1: { type: ControlType.String, title: "Z3 · PDESC Item 1", defaultValue: "프라이버시 디스크립터" },
  z3PdescItem2: { type: ControlType.String, title: "Z3 · PDESC Item 2", defaultValue: "격리 연산 존" },
  z3PdescItem3: { type: ControlType.String, title: "Z3 · PDESC Item 3", defaultValue: "출력 비식별화" },
  z3PdescFoot: { type: ControlType.String, title: "Z3 · PDESC Foot", defaultValue: "재식별 시도 차단 · 출력 검증 완료" },
  z3ComplianceLabel: { type: ControlType.String, title: "Z3 · Compliance Label", defaultValue: "컴플라이언스" },
  z3Compliance1: { type: ControlType.String, title: "Z3 · Compliance Badge 1", defaultValue: "EU GDPR" },
  z3Compliance2: { type: ControlType.String, title: "Z3 · Compliance Badge 2", defaultValue: "EU 리전" },
  z4GroupTag: { type: ControlType.String, title: "Z4 · DB Group Tag", defaultValue: "복원 플로우" },
  z4InSub: { type: ControlType.String, title: "Z4 · IN Sub", defaultValue: "AI 토큰<br/>토큰화된 응답" },
  z4ProcessSub: { type: ControlType.String, title: "Z4 · PROCESS Sub", defaultValue: "복원<br/>로컬 복구" },
  z4OutSub: { type: ControlType.String, title: "Z4 · OUT Sub", defaultValue: "원본 값<br/>비즈니스 즉시 활용" },
  z4BlockLabel: { type: ControlType.String, title: "Z4 · Token Block Label", defaultValue: "토큰 → 원본" },
  z4F1Name: { type: ControlType.String, title: "Z4 · Field 1 Name", defaultValue: "고객" },
  z4F2Name: { type: ControlType.String, title: "Z4 · Field 2 Name", defaultValue: "티켓" },
  z4F3Name: { type: ControlType.String, title: "Z4 · Field 3 Name", defaultValue: "상세" },
  z4ReconName: { type: ControlType.String, title: "Z4 · Recon Engine Name", defaultValue: "복원" },
  z4ReconBadge: { type: ControlType.String, title: "Z4 · Recon Engine Badge", defaultValue: "로컬 전용" },
  z4ReconTech1: { type: ControlType.String, title: "Z4 · Recon Tech 1", defaultValue: "토큰 맵 조회" },
  z4ReconTech2: { type: ControlType.String, title: "Z4 · Recon Tech 2", defaultValue: "원본 값 복원" },
  z4ReconTech3: { type: ControlType.String, title: "Z4 · Recon Tech 3", defaultValue: "컨텍스트 재결합" },
  z4ReconTech4: { type: ControlType.String, title: "Z4 · Recon Tech 4", defaultValue: "출력 검증" },
  z4LocalStrong: { type: ControlType.String, title: "Z4 · Local Guarantee Title", defaultValue: "로컬 복원 보장" },
  z4LocalBody: { type: ControlType.String, title: "Z4 · Local Guarantee Body", defaultValue: "토큰 맵은 로컬 스토리지에만 존재합니다 · <b>즉시 비즈니스 활용 가능한 출력을 제공합니다</b>", displayTextArea: true },
  z4OutputLabel: { type: ControlType.String, title: "Z4 · Output Properties Label", defaultValue: "출력 속성" },
  z4OutCheck1: { type: ControlType.String, title: "Z4 · Output Check 1", defaultValue: "원본 값 복원 완료" },
  z4OutCheck2: { type: ControlType.String, title: "Z4 · Output Check 2", defaultValue: "외부 노출 없음" },
  z4OutCheck3: { type: ControlType.String, title: "Z4 · Output Check 3", defaultValue: "컨텍스트 완전 보존" },
  z4OutCheck4: { type: ControlType.String, title: "Z4 · Output Check 4", defaultValue: "비즈니스 즉시 활용 출력" },
  z4Chip1: { type: ControlType.String, title: "Z4 · Chip 1", defaultValue: "자동 복원" },
  z4Chip2: { type: ControlType.String, title: "Z4 · Chip 2", defaultValue: "로컬 전용" },
  z4Chip3: { type: ControlType.String, title: "Z4 · Chip 3", defaultValue: "데이터 레지던시" },
  coreTitle: { type: ControlType.String, title: "Core · Section Title", defaultValue: "6가지 핵심 기능" },
  coreWorkflowGroup: { type: ControlType.String, title: "Core · Workflow Group Label", defaultValue: "워크플로우를 작동시키는 것" },
  coreApprovalGroup: { type: ControlType.String, title: "Core · Approval Group Label", defaultValue: "승인을 이끌어내는 것" },
  core1Name: { type: ControlType.String, title: "Core 01 · Name", defaultValue: "구조 보존" },
  core1Desc: { type: ControlType.String, title: "Core 01 · Description", defaultValue: "테이블, 로그, 상호 참조, 알람 시퀀스가 그대로 유지됩니다. AI는 텍스트뿐만 아니라 구조를 읽습니다.", displayTextArea: true },
  core2Name: { type: ControlType.String, title: "Core 02 · Name", defaultValue: "엔터프라이즈 환경 내 실행" },
  core2Desc: { type: ControlType.String, title: "Core 02 · Description", defaultValue: "고객사 환경 내부에 배포됩니다. API, SDK, 커넥터, 또는 리버스 프록시로 연결합니다. 트래픽 재라우팅이 없습니다.", displayTextArea: true },
  core3Name: { type: ControlType.String, title: "Core 03 · Name", defaultValue: "비즈니스 즉시 활용 복원" },
  core3Desc: { type: ControlType.String, title: "Core 03 · Description", defaultValue: "AI 출력이 실제 값으로 복원됩니다. 결과물은 원래의 티켓이나 워크플로우로 바로 반환됩니다.", displayTextArea: true },
  core4Name: { type: ControlType.String, title: "Core 04 · Name", defaultValue: "조직 정의 민감정보" },
  core4Desc: { type: ControlType.String, title: "Core 04 · Description", defaultValue: "IT 관리자가 직접 민감 기준을 정의합니다. 커스텀 마커, 정규식 규칙, 등급 정책을 5분 안에 설정합니다.", displayTextArea: true },
  core5Name: { type: ControlType.String, title: "Core 05 · Name", defaultValue: "Zero Exposure &amp; 감사" },
  core5Desc: { type: ControlType.String, title: "Core 05 · Description", defaultValue: "원본 운영 데이터는 내부에 머뭅니다. 모든 행위가 기록·타임스탬프 처리되며 SIEM으로 내보낼 수 있습니다.", displayTextArea: true },
  core6Name: { type: ControlType.String, title: "Core 06 · Name", defaultValue: "시간 변동 정책" },
  core6Desc: { type: ControlType.String, title: "Core 06 · Description", defaultValue: "민감도 기준은 시간이 지남에 따라 변합니다. Capsule은 지속적인 규제 대응을 위해 모든 마커와 정책을 버전 관리합니다.", displayTextArea: true },
  coreStrip: { type: ControlType.String, title: "Core · Bottom Strip", defaultValue: "01·02가 대화를 이끌고, 05·06이 승인을 뒷받침합니다." },
})
