    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @container (min-width: 1440px) { .rst-article-container { padding: 0 120px; max-width: 1440px; } }
        ...
        .rst-text--product { font-family: var(--f-display, 'Inter'), sans-serif; font-weight: 700; }
        ...
        .rst-cta-band__title .rst-text--product { font-family: var(--f-display, 'Inter'), sans-serif; }
