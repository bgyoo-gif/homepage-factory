  ...
  return (
    <>
      <style>{`
        ...
        .p3-arch{margin-top:28px;border:1px solid #e5e7eb;border-radius:16px;padding:8px;background:#f7f8fb}
        .p3-arch svg{width:100%;height:auto;display:block}
        .p3-cmp{width:100%;border-collapse:separate;border-spacing:0;margin-top:24px;font-size:14px;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;font-family:'Inter',sans-serif}
