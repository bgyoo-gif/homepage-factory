...
const LEARN_CARDS: CardData[] = [
  ...
  { slug: "external-llm-on-sensitive-enterprise-data", category: "architecture-onprem", href: "/resources/learn/external-llm-on-sensitive-enterprise-data", locales: ["en"], skipInIndex: false, title: { en: "Running External LLMs on Data Your Company Can't Send Externally" }, desc: { en: "Most enterprise AI workflows stall when external LLMs require data the company can't expose. A look at the architectural patterns that move past the stall — and what trade-offs each one carries." } },
  { slug: "tokenization-for-llm-inputs", category: "architecture-onprem", href: "/resources/learn/tokenization-for-llm-inputs", locales: ["en"], skipInIndex: false, title: { en: "Tokenization for LLM Inputs: How AI Reads What It Doesn't See" }, desc: { en: "The architectural choices that make pre-LLM tokenisation work in production — deterministic vs randomised, format preservation, mapping storage, and the questions teams have to settle before deployment." } },
  { slug: "reconstructing-ai-output", category: "architecture-onprem", href: "/resources/learn/reconstructing-ai-output", locales: ["en"], skipInIndex: false, title: { en: "Reconstructing AI Output: The Last Mile Between Model Response and Business Reality" }, desc: { en: "The tokenised response from an external LLM is not yet usable. Reconstruction is what turns it into business-ready output — and where most teams underinvest until the workflow stalls in production." } },
  { slug: "why-ai-stalls-on-operational-data", category: "comparison", href: "/resources/learn/why-ai-stalls-on-operational-data", locales: ["en"], skipInIndex: false, title: { en: "Why AI Workflows Stall at Tables, Tickets, and Operational Documents" }, desc: { en: "PII guardrails and field-level masking solve the easy half of the problem and break the rest of the workflow. A look at where AI stalls on real operational data — and why removal-based approaches can't fix it." } },
