...
const DEFAULT_CARDS: ArticleCard[] = [
  ...
  {
    href: "/resources/learn/restorable-workflow",
    badgeType: "neutral",
    badgeLabel: "Glossary",
  ...
  {
    href: "/resources/learn/enterprise-context-control",
    badgeType: "neutral",
    badgeLabel: "Glossary",
...
export default function Learn({
  ...
  card13Href = "/resources/learn/restorable-workflow",
  card14Title = "Enterprise Context Control",
  card14Badge = "Glossary",
  card14Href = "/resources/learn/enterprise-context-control",
