...
addPropertyControls(SovereignAiEuropeanEnterprises, {
  ...
  related3Title: { type: ControlType.String, title: "Related 3 Title", defaultValue: "How to deploy AI in a telecom NOC without exposing network data" },
  related3Href: { type: ControlType.String, title: "Related 3 URL", defaultValue: "/resources/learn/telecom-noc-ai-deployment" },
  related4Title: { type: ControlType.String, title: "Related 4 Title", defaultValue: "Glossary: Two execution paths" },
  related4Href: { type: ControlType.String, title: "Related 4 URL", defaultValue: "/resources/glossary/two-execution-paths" },
})
