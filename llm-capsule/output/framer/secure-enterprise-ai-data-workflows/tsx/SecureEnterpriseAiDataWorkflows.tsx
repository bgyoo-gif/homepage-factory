...
function AcCard({ question, answer, defaultOpen = false }: { question: string; answer: string; defaultOpen?: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontFamily: 'var(--f-display, 'Inter'), sans-serif', fontSize: 18, fontWeight: 500, lineHeight: 1.2, color: P.textPrimary }}>
          {question}
        </span>
        <span
          style={{
    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Text utilities ─────────────────────────────────────── */
        .seadw-text--product { font-family: var(--f-display, 'Inter'), sans-serif; font-weight: 700; }
          ...
          <main>
            ...
            <section id="section-hero" className="seadw-section--hero">
              <div className="seadw-article-container">
                ...
                <h1 className="seadw-article-hero__title" style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>{heroTitle}</h1>
            ...
            <section id="section-2" className="seadw-section--article-body">
              <div className="seadw-article-container">
                <div className="seadw-article-section-header">
                  <h2 style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>Problem</h2>
                </div>
            ...
            <section id="section-3" className="seadw-section--article-body">
              <div className="seadw-article-container">
                <div className="seadw-article-section-header">
                  <h2 style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>Definition</h2>
                </div>
            ...
            <section id="section-4" className="seadw-section--article-body">
              <div className="seadw-article-container">
                <div className="seadw-article-section-header">
                  <h2 style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>Explanation</h2>
                </div>
            ...
            <section id="section-5" className="seadw-section--article-body">
              <div className="seadw-article-container">
                <div className="seadw-article-section-header">
                  <h2 style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>Enterprise Examples</h2>
                </div>
            ...
            <section id="section-cta" className="seadw-cta-band">
              <div className="seadw-cta-band__inner">
                <h2 className="seadw-cta-band__title" style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>
                  {ctaTitle}
                </h2>
