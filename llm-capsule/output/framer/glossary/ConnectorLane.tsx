...
addPropertyControls(ConnectorLane, {
  ...
  definitionBody: { type: ControlType.String, title: "Definition Body", defaultValue: "The connector lane describes how LLM Capsule, running inside the customer's environment (on-prem, air-gapped, or VPC), reads from the document, ticket, and operational systems that already live in that environment. It is not a SaaS integration platform that calls into customer systems from the outside, and it is not an API marketplace.", displayTextArea: true },
