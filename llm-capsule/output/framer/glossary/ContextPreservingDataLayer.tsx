...
export default function ContextPreservingDataLayer({
  locale = "en",
  backLabel = "",
  backHref = "",
  term = "",
...
addPropertyControls(ContextPreservingDataLayer, {
