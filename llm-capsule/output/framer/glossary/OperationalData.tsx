...
addPropertyControls(OperationalData, {
  ...
  definitionBody: { type: ControlType.String, title: "Definition Body", defaultValue: "Operational data is the structured and unstructured enterprise data generated by ongoing business operations. It includes the records, logs, configurations, alarms, tickets, runbooks, workflows, and contextual references that operations teams produce and consume daily.", displayTextArea: true },
