...
// GlossaryDetail — Reusable component for all /glossary/* pages
// Structure: Hero (back link, h1, lead, category chip) → Definition block → Article Body → Related Terms
// v6.2 rules: no PALETTE, var(--c-*) tokens only, @container for responsive, Inter font, no solid buttons
// Props match GlossaryDetail CMS Collection schema
// bodyHtml accepts raw HTML string (h2/h3/p/ul/ol/blockquote/code)
...
addPropertyControls(GlossaryDetail, {
  // Hero
