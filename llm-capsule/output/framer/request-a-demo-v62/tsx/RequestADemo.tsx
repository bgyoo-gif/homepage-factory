    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @container (min-width: 1440px) { .rpov-container { padding: 0 80px; } }
        ...
        .rpov-btn--primary:hover { background: var(--c-primary, #5b4fe9); }
        .rpov-btn--secondary {
          background-color: transparent;
          color: var(--c-ink, #0f1130);
          border: 1px solid var(--c-rule, #e5e7eb);
        }
        .rpov-btn--secondary:hover { background-color: var(--c-bg-soft, #f7f8fb); }

        /* ── Text utility ────────────────────────────────────────── */
        .rpov-text--brand { color: var(--c-primary, #5b4fe9); }
        .rpov-text--product { font-family: var(--f-display, 'Inter'), sans-serif; font-weight: 700; }
        ...
        .rpov-hero__title {
          ...
          color: var(--c-ink, #0f1130); line-height: 1.2;
        ...
        .rpov-hero__description {
          font-size: 18px; color: var(--c-ink-soft, #3a3d5e);
        ...
        @container (min-width: 1024px) {
          .rpov-layout { grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 64px; }
        }
        ...
        .rpov-process__header p {
          font-size: 16px; color: var(--c-ink-soft, #3a3d5e); line-height: 1.7;
        }
        ...
        .rpov-step-tabs__tab {
          ...
          color: var(--c-ink-soft, #3a3d5e); cursor: pointer;
          border: none; border-bottom: 2px solid transparent;
          white-space: nowrap; background: none;
          font-family: var(--f-display, 'Inter'), sans-serif;
          transition: color 0.2s, border-color 0.2s;
        }
        .rpov-step-tabs__tab:hover { color: var(--c-ink, #0f1130); }
        ...
        .rpov-step-tabs__icon { color: var(--c-primary, #5b4fe9); }
        ...
        .rpov-banner {
          ...
          font-size: 14px; color: var(--c-ink-soft, #3a3d5e);
          line-height: 1.7;
          word-break: keep-all;
        }
        ...
        .rpov-form-group textarea:focus {
          ...
          box-shadow: 0 0 0 3px var(--c-primary-soft, #eeebfe);
        }
        .rpov-form-group input::placeholder,
        .rpov-form-group textarea::placeholder { color: var(--c-muted, #6b7280); }
        .rpov-form-group select option[value=""] { color: var(--c-muted, #6b7280); }
        ...
        .rpov-form__footnote--success { color: var(--c-teal, #0ea5a4); }
        .rpov-form__footnote--error { color: var(--c-coral, #ef5350); }
                ...
                <div className="rpov-layout">
                    ...
                    <div>
                      ...
                      {tabs.map((tab) => (
                        ...
                        >
                          ...
                          <p className="rpov-step-tabs__description">{tab.description}</p>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="rpov-form-card">
                    ...
                    >
                      ...
                      {formStatus === "success" && (
                        <p className="rpov-form__footnote rpov-form__footnote--success">
                          Thank you! We will be in touch within 1 business day.
                        </p>
                      )}
                      {formStatus === "error" && (
                        <p className="rpov-form__footnote rpov-form__footnote--error">
