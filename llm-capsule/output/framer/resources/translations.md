...
| s2Card2Description | Definitions of key concepts — restoration, zero exposure, enterprise context control, and structure-preserving processing. | restoration, zero exposure, enterprise context control, structure-preserving processing 등 핵심 개념을 정의합니다. |
| s2Card2BtnLabel | Browse Glossary → | 용어집 보기 → |
| s2Card2Href | glossary.html | glossary.html |
| s2Card3Title | Trust Center | 트러스트 센터 |
...
| s3Guide1BtnLabel | Read guide → | 가이드 읽기 → |
| s3Guide1Href | secure-enterprise-ai-data-workflows.html | secure-enterprise-ai-data-workflows.html |
| s3Guide2Title | What Is an AI Data Capsule? | AI Data Capsule이란 무엇인가? |
| s3Guide2Description | The core concept behind local encapsulation, protected AI processing, and local restoration. | 로컬 캡슐화, 보호된 AI 처리, 로컬 복원의 핵심 개념을 설명합니다. |
| s3Guide2BtnLabel | Read guide → | 가이드 읽기 → |
| s3Guide2Href | what-is-ai-data-capsule.html | what-is-ai-data-capsule.html |
| s3Guide3Title | Why Redaction Breaks Enterprise AI Workflows | 편집(Redaction)이 엔터프라이즈 AI 워크플로를 망가뜨리는 이유 |
| s3Guide3Description | Why masking and redaction tools fail in AI workflows, and what replaces them in enterprise production settings. | AI 워크플로에서 마스킹·편집 도구가 실패하는 이유와 엔터프라이즈 운영 환경에서 이를 대체하는 방법을 설명합니다. |
| s3Guide3BtnLabel | Read guide → | 가이드 읽기 → |
| s3Guide3Href | why-redaction-breaks-enterprise-ai-workflows.html | why-redaction-breaks-enterprise-ai-workflows.html |
| ctaTitle | See how LLM Capsule works with your data | LLM Capsule이 귀사의 데이터에서 어떻게 작동하는지 확인하세요 |
| ctaDescription | Bring your documents, deployment constraints, and evaluation criteria. We demonstrate on your actual workflows. | 보유하신 문서, 배포 제약 조건, 평가 기준을 가져오세요. 실제 워크플로를 기반으로 직접 시연해 드립니다. |
| ctaBtn1Label | Request a Demo | 데모 신청하기 |
| ctaBtn1Href | request-pov.html | request-pov.html |
| ctaSecBtn2Label | Available on AWS Marketplace | AWS Marketplace에서 이용 가능 |
| ctaSecBtn2Href | https://aws.amazon.com/marketplace | https://aws.amazon.com/marketplace |
...
| s2Card2Description | Definitions of key concepts — restoration, zero exposure, enterprise context control, and structure-preserving processing. | restoration、zero exposure、enterprise context control、structure-preserving processing などの主要概念の定義を掲載しています。 |
| s2Card2BtnLabel | Browse Glossary → | 用語集を見る → |
| s2Card2Href | glossary.html | glossary.html |
| s2Card3Title | Trust Center | トラストセンター |
...
| s3Guide1BtnLabel | Read guide → | ガイドを読む → |
| s3Guide1Href | secure-enterprise-ai-data-workflows.html | secure-enterprise-ai-data-workflows.html |
| s3Guide2Title | What Is an AI Data Capsule? | AI Data Capsule とは何か？ |
| s3Guide2Description | The core concept behind local encapsulation, protected AI processing, and local restoration. | ローカルカプセル化、保護された AI 処理、ローカル復元の中核概念を解説します。 |
| s3Guide2BtnLabel | Read guide → | ガイドを読む → |
| s3Guide2Href | what-is-ai-data-capsule.html | what-is-ai-data-capsule.html |
| s3Guide3Title | Why Redaction Breaks Enterprise AI Workflows | なぜ Redaction がエンタープライズ AI ワークフローを壊すのか |
| s3Guide3Description | Why masking and redaction tools fail in AI workflows, and what replaces them in enterprise production settings. | AI ワークフローにおいてマスキング・編集ツールが機能しない理由と、エンタープライズ本番環境でそれらに代わるものを解説します。 |
| s3Guide3BtnLabel | Read guide → | ガイドを読む → |
| s3Guide3Href | why-redaction-breaks-enterprise-ai-workflows.html | why-redaction-breaks-enterprise-ai-workflows.html |
| ctaTitle | See how LLM Capsule works with your data | LLM Capsule が貴社のデータでどのように機能するかをご覧ください |
| ctaDescription | Bring your documents, deployment constraints, and evaluation criteria. We demonstrate on your actual workflows. | 保有するドキュメント、デプロイ制約、評価基準をご持参ください。実際のワークフローをもとにデモをご覧いただけます。 |
| ctaBtn1Label | Request a Demo | デモを申し込む |
| ctaBtn1Href | request-pov.html | request-pov.html |
| ctaSecBtn2Label | Available on AWS Marketplace | AWS Marketplace で利用可能 |
| ctaSecBtn2Href | https://aws.amazon.com/marketplace | https://aws.amazon.com/marketplace |
...
| s2Card2Description | Definitions of key concepts — restoration, zero exposure, enterprise context control, and structure-preserving processing. | Definitionen zentraler Konzepte — Restoration, Zero Exposure, Enterprise Context Control und Structure-Preserving Processing. |
| s2Card2BtnLabel | Browse Glossary → | Glossar ansehen → |
| s2Card2Href | glossary.html | glossary.html |
| s2Card3Title | Trust Center | Trust Center |
...
| s3Guide1BtnLabel | Read guide → | Leitfaden lesen → |
| s3Guide1Href | secure-enterprise-ai-data-workflows.html | secure-enterprise-ai-data-workflows.html |
| s3Guide2Title | What Is an AI Data Capsule? | Was ist eine AI Data Capsule? |
| s3Guide2Description | The core concept behind local encapsulation, protected AI processing, and local restoration. | Das Kernkonzept hinter lokaler Kapselung, geschützter KI-Verarbeitung und lokaler Wiederherstellung. |
| s3Guide2BtnLabel | Read guide → | Leitfaden lesen → |
| s3Guide2Href | what-is-ai-data-capsule.html | what-is-ai-data-capsule.html |
| s3Guide3Title | Why Redaction Breaks Enterprise AI Workflows | Warum Redaction Enterprise-AI-Workflows beeinträchtigt |
| s3Guide3Description | Why masking and redaction tools fail in AI workflows, and what replaces them in enterprise production settings. | Warum Maskierungs- und Redaction-Tools in KI-Workflows versagen und was sie in Enterprise-Produktionsumgebungen ersetzt. |
| s3Guide3BtnLabel | Read guide → | Leitfaden lesen → |
| s3Guide3Href | why-redaction-breaks-enterprise-ai-workflows.html | why-redaction-breaks-enterprise-ai-workflows.html |
| ctaTitle | See how LLM Capsule works with your data | Erleben Sie, wie LLM Capsule mit Ihren Daten funktioniert |
| ctaDescription | Bring your documents, deployment constraints, and evaluation criteria. We demonstrate on your actual workflows. | Bringen Sie Ihre Dokumente, Deployment-Anforderungen und Bewertungskriterien mit. Wir demonstrieren anhand Ihrer tatsächlichen Workflows. |
| ctaBtn1Label | Request a Demo | Demo anfragen |
| ctaBtn1Href | request-pov.html | request-pov.html |
| ctaSecBtn2Label | Available on AWS Marketplace | Im AWS Marketplace verfügbar |
| ctaSecBtn2Href | https://aws.amazon.com/marketplace | https://aws.amazon.com/marketplace |
