          ...
          <main>
            ...
            <section id="section-hero" className="spp-section--hero">
              <div className="spp-article-container">
                ...
                <h1 className="spp-article-hero__title" style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>{heroTitle}</h1>
            ...
            <section id="section-4" className="spp-section--article-body">
              <div className="spp-article-container">
                <div className="spp-article-section-header">
                  <h2 style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>How Flat Masking Works</h2>
                </div>
            ...
            <section id="section-6" className="spp-section--article-body">
              <div className="spp-article-container">
                <div className="spp-article-section-header">
                  <h2 style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>How <span className="spp-text--product">LLM Capsule</span> Differs</h2>
                </div>
            ...
            <section id="section-cta" className="spp-cta-band">
              <div className="spp-cta-band__inner">
                <h2 className="spp-cta-band__title" style={{ wordBreak: "keep-all", whiteSpace: "pre-line" }}>
                  {ctaTitle}
                </h2>
