...
export default function Section09_CTABand({
  ...
  btn1_label_ko = "데모 요청",
  btn1_href = "request-pov.html",
  btn2_label_en = "View Product",
  btn2_label_ko = "제품 보기",
  btn2_href = "product.html",
...
addPropertyControls(Section09_CTABand, {
  ...
  btn1_href: { type: ControlType.String, title: "Button 1 URL", defaultValue: "request-pov.html" },
  ...
  btn2_href: { type: ControlType.String, title: "Button 2 URL", defaultValue: "product.html" },
