...
export default function Section05_HowItWorks({
  ...
  intro_en = "LLM Capsule operates as a context-preserving data layer for AI between enterprise data systems and external AI services. The process follows four steps:",
  intro_ko = "LLM Capsule은 기업 데이터 시스템과 외부 AI 서비스 사이에서 AI를 위한 컨텍스트 보존 데이터 레이어로 운영됩니다. 프로세스는 네 단계를 따릅니다:",
...
addPropertyControls(Section05_HowItWorks, {
  ...
  intro_en: { type: ControlType.String, title: "Intro (EN)", defaultValue: "LLM Capsule operates as a context-preserving data layer for AI...", displayTextArea: true },
